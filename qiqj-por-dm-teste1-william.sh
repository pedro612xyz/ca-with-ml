...
transforma="/home/pedro/Documents/personal-data/mestrado/dissertacao/ideias/rogue-aps/revisao-qualificacao/testes/2015-09-19/captura-gateway/teste1/testeabc/transforma-q.sh"

rm q-output-test.txt
...
#echo dados do $j
#echo  pressione enter para continuar
./didj -H -w  -i qiqj-temp.txt > "/home/pedro/Documents/personal-data/mestrado/dissertacao/ideias/rogue-aps/revisao-qualificacao/testes/2015-09-19/captura-gateway/teste1/testeabc/q-output.txt"
