...
read
  ...
  # do
   argumentocomando="$argumentocomando,FRAMES()ip.src==$j and   tcp.flags.syn != 1 and tcp.flags.reset == 1  and tcp.flags.ack != 1 and tcp.flags.fin != 1 and tcp.flags.ns != 1 and tcp.flags.push != 1 and tcp.flags.res != 1 and tcp.flags.urg != 1 and tcp.flags.cwr != 1 and tcp.flags.ecn != 1"
